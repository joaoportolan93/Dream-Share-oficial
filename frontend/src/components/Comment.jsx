        ...
        >
            ...
            >
                ...
                {hasReplies && showThreadLine && depth < maxDepth && (
                    <ParentLine commentId={comment.id_comentario} />
                )}
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {!isEditing && (
                            <div className="flex items-center justify-between mt-3 max-w-md">
                                ...
                                <button className="flex items-center gap-1 text-gray-500 hover:text-green-400 group transition-colors">
            ...
            {/* Nested Replies - outside article so ParentLine extends through them */}
